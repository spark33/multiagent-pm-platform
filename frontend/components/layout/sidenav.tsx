...
export function Sidenav() {
  ...
  return (
    <div className="w-64 border-r bg-card flex flex-col h-screen sticky top-0">
      ...
      <div className="p-4">
        <Link href="/">
          <h1 className="text-lg font-bold">Multi-Agent PM</h1>
        </Link>
      </div>
      ...
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
        <Link href="/">
          <Button
            variant={isActive("/") && !pathname.includes("/projects") ? "secondary" : "ghost"}
        ...
        {/* Projects list would go here - for now just a placeholder */}
        <Link href="/projects">
          <Button
